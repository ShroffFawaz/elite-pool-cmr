    ...
    <div className="page" id="page_users">
      ...
      <div className="card" style={{ padding: 0 }}>
        <div className="tw" style={{ border: 'none' }}>
          <table>
            <thead>
              <tr><th>Name</th><th>Email</th><th>Role</th><th>Status</th><th>Last Active</th><th style={{ textAlign: 'right' }}>Actions</th></tr>
            </thead>
            <tbody>
              {users.map(u => (
                <tr key={u.id}>
                  ...
                  <td><StatusBadge status={!u.disabled ? 'quoted' : 'closed'} /></td>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '6px', justifyContent: 'flex-end' }}>
                      ...
                      <button className="btn btn-ghost btn-sm" title={!u.disabled ? 'Deactivate' : 'Activate'} onClick={() => toggleUser(u)}>
                        {!u.disabled ? (
